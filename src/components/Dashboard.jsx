...
const Dashboard = ({ history, currentTask, setCurrentTask, totalXP, systemLogs, onOpenShop }) => {
    ...
    return (
        <div className="h-full flex flex-col gap-6 text-white">
            {/* Header / Stats */}
            <div className="flex-none bg-slate-900/50 rounded-2xl p-4 border border-white/5 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div className="flex-none relative">
                        <AvatarDisplay config={avatarConfig} size="md" className="border-2 border-blue-400/50 shadow-[0_0_15px_rgba(59,130,246,0.3)]" />
                        <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-slate-900 rounded-full flex items-center justify-center border border-blue-500/30">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start mb-1">
                            <div>
                                <h2 className="text-xl font-bold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-200 truncate">
                                    NEURAL LINK
                                </h2>
                                <div className="text-[10px] text-blue-300/70 font-mono tracking-wider">STATUS: ONLINE</div>
                            </div>
                            <button
                                onClick={onOpenShop}
                                className="px-3 py-1.5 bg-yellow-500/10 hover:bg-yellow-500/20 border border-yellow-500/50 text-yellow-300 text-[10px] font-bold rounded flex items-center gap-2 transition-all hover:shadow-[0_0_10px_rgba(234,179,8,0.2)]"
                            >
                        ...
                        <div className="flex items-center justify-between text-xs mb-1">
                            <span className="font-bold text-blue-300">LEVEL {level}</span>
                            <span className="font-mono text-blue-300/50">{totalXP} XP</span>
                        </div>
